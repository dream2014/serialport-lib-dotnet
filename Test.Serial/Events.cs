/*
  This file is part of MetaLib (https://github.com/genielabs/zwave-lib-dotnet)
...
namespace MetaLib
{
    ...
    public class NodeEvent
    {
        ...
        public NodeEvent(MetaNode node, object eventValue, int instance)
        {
            Node = node;
            Value = eventValue;
            Instance = instance;
    ...
    {
        public readonly MetaMessage Message;
        public readonly DateTime Timestamp;

        public MessageReceivedEventArgs(MetaMessage message)
        {
            Message = message;
            Timestamp = DateTime.UtcNow;
        }
